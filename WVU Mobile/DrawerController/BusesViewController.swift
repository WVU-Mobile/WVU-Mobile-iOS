...
class BusesViewController: CenterViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func initilizeOnlineOffline () {
        ...
        format.dateFormat = "e"
        let dateInt = Int(format.stringFromDate(today))
