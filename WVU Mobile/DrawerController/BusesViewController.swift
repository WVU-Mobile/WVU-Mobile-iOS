...
class BusesViewController: CenterViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func setupRoutes () {
        ...
        var westRunLate = BusLine(name: "West Run Late (30)", stops: ["West Run Apartments", "Copper Beech", "Stewartstown & West Run Rd", "Stewart & Glenmark Ave", "Bon Vista", "Cedarwood Drive", "Hampton Center", "Chestnut Ridge and Stewartstown", "Stewart Place", "Kingston and Stewart", "Stewart and Hoffman", "Express Mart", "Stewart and University", "Loop Area - University Ave", "University and Falling Run", "E. Moore Hall", "Willey and University", "High and Willey", "Fayette and High", "Met Theatre", "Court House", "High and Pleasant", "Pleasant and Spruce", "Public Safety Building", "Spruce Street", "Spruce and Willey", "Mountainlair", "Shorty Anderson's", "Lewis Street"], map: UIImage(named: ""),
            hours: ["", "", "", "", "6:00 PM - 2:50 AM", "6:00 PM - 2:50 AM", "6:00 PM - 2:50 AM"],
            hoursString: "Thursday - Saturday 7:10 AM to 2:30 AM \n Run Time: ~20 - 30 minutes", twitter: "ML30wr")
        
        var blueAndGold = BusLine(name: "Blue & Gold (38)", stops: ["Towers", "Evansdale McDonalds", "Law School Drive", "Grant and 6th", "4th Street", "Grant & 1st", "Beechurst and Campus", "Beechurst and 3rd", "Beechurst and 6th", "Beechurst and 8th", "Creative Arts Center", "Engineering Loop", "Evansdale Library", "Allen Hall"], map: UIImage(named: ""),
