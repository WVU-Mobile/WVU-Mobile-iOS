...
//  WVU Mobile
//
//  Created by Richard Deal on 2/19/15.
...
class RefreshController: CenterViewController {
    var PRTView: PRTViewController!
    var refreshControl: UIRefreshControl!
    var refreshLoadingView: UIView!
    var refreshColorView: UIView!
    var compass_background: UIImageView!
    var compass_spinner: UIImageView!
    var isRefreshIconsOverlap: Bool!
    ...
    func setupRefreshControl() {
        ...
        compass_background = UIImageView(image: UIImage(named: "mount.png"))
        self.compass_spinner = UIImageView(image: UIImage(named: "mount.png"))
    ...
    override init() {
        super.init()
        self.restorationIdentifier = "RefreshController"
    }
